        ...
        <div className="relative mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="mx-auto mt-3 max-w-lg text-mist">
              Enter your order ID and phone number to see live order status — confirmed, shipped or
              delivered.
            </p>
          </motion.div>
            ...
            {order ? (
              ...
              >
                ...
                <p className="mt-5 text-xs text-mist">
                  You can find your order ID in the confirmation message shown right after checkout.
                  The phone number must match the one used while placing the order.
                </p>
              </form>
            )}
          </motion.div>
